...
import ckathode.weaponmod.WMClientProxy;
import ckathode.weaponmod.WMCommonProxy;
import ckathode.weaponmod.WMConfigCondition;
...
public class BalkonsWeaponModForge {
    public static BalkonsWeaponModForge instance;
    ...
    private <T extends Entity> EntityType<T> createEntityType(String name, EntityDimensions size,
    ...
    private <T extends Entity> EntityType<T> createEntityType(String name, EntityDimensions size, int range,
    ...
    public void registerEntities(RegistryEvent.Register<EntityType<?>> event) {
        ...
        registry.register(entitySpear =
                createEntityType(EntitySpear.NAME, new EntityDimensions(0.5f, 0.5f, false), EntitySpear::new));

        registry.register(entityKnife =
                createEntityType(EntityKnife.NAME, new EntityDimensions(0.5f, 0.5f, false), EntityKnife::new));

        registry.register(entityJavelin =
                createEntityType(EntityJavelin.NAME, new EntityDimensions(0.5f, 0.5f, false), EntityJavelin::new));

        registry.register(entityMusketBullet =
                createEntityType(EntityMusketBullet.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityMusketBullet::new));

        registry.register(entityCrossbowBolt =
                createEntityType(EntityCrossbowBolt.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityCrossbowBolt::new));

        registry.register(entityBlowgunDart =
                createEntityType(EntityBlowgunDart.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityBlowgunDart::new));

        registry.register(entityDynamite =
                createEntityType(EntityDynamite.NAME, new EntityDimensions(0.5f, 0.5f, false), EntityDynamite::new));

        registry.register(entityFlail =
                createEntityType(EntityFlail.NAME, new EntityDimensions(0.5f, 0.5f, false), EntityFlail::new));

        registry.register(entityCannon =
                createEntityType(EntityCannon.NAME, new EntityDimensions(1.5f, 1.0f, false), EntityCannon::new));
        registry.register(entityCannonBall =
                createEntityType(EntityCannonBall.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityCannonBall::new));

        registry.register(entityBlunderShot =
                createEntityType(EntityBlunderShot.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityBlunderShot::new));

        registry.register(entityDummy =
                createEntityType(EntityDummy.NAME, new EntityDimensions(0.5f, 1.9f, false), 4, 20, true,
                        EntityDummy::new));

        registry.register(entityBoomerang =
                createEntityType(EntityBoomerang.NAME, new EntityDimensions(0.5f, 0.5f, false), EntityBoomerang::new));

        registry.register(entityMortarShell =
                createEntityType(EntityMortarShell.NAME, new EntityDimensions(0.5f, 0.5f, false),
                        EntityMortarShell::new));
    }

    @SubscribeEvent
    public void registerItems(RegistryEvent.Register<Item> event) {
        IForgeRegistry<Item> registry = event.getRegistry();
        registry.register(spearWood = new ItemMelee("spear.wood", new MeleeCompSpear(Tiers.WOOD)));
        registry.register(spearStone = new ItemMelee("spear.stone", new MeleeCompSpear(Tiers.STONE)));
        registry.register(spearSteel = new ItemMelee("spear.iron", new MeleeCompSpear(Tiers.IRON)));
        registry.register(spearGold = new ItemMelee("spear.gold", new MeleeCompSpear(Tiers.GOLD)));
        registry.register(spearDiamond = new ItemMelee("spear.diamond", new MeleeCompSpear(Tiers.DIAMOND)));

        registry.register(halberdWood = new ItemMelee("halberd.wood", new MeleeCompHalberd(Tiers.WOOD)));
        registry.register(halberdStone = new ItemMelee("halberd.stone", new MeleeCompHalberd(Tiers.STONE)));
        registry.register(halberdSteel = new ItemMelee("halberd.iron", new MeleeCompHalberd(Tiers.IRON)));
        registry.register(halberdGold = new ItemMelee("halberd.gold", new MeleeCompHalberd(Tiers.GOLD)));
        registry.register(halberdDiamond = new ItemMelee("halberd.diamond", new MeleeCompHalberd(Tiers.DIAMOND)));

        registry.register(battleaxeWood = new ItemMelee("battleaxe.wood", new MeleeCompBattleaxe(Tiers.WOOD)));
        registry.register(battleaxeStone = new ItemMelee("battleaxe.stone", new MeleeCompBattleaxe(Tiers.STONE)));
        registry.register(battleaxeSteel = new ItemMelee("battleaxe.iron", new MeleeCompBattleaxe(Tiers.IRON)));
        registry.register(battleaxeGold = new ItemMelee("battleaxe.gold", new MeleeCompBattleaxe(Tiers.GOLD)));
        registry.register(battleaxeDiamond = new ItemMelee("battleaxe.diamond",
                new MeleeCompBattleaxe(Tiers.DIAMOND)));

        registry.register(knifeWood = new ItemMelee("knife.wood", new MeleeCompKnife(Tiers.WOOD)));
        registry.register(knifeStone = new ItemMelee("knife.stone", new MeleeCompKnife(Tiers.STONE)));
        registry.register(knifeSteel = new ItemMelee("knife.iron", new MeleeCompKnife(Tiers.IRON)));
        registry.register(knifeGold = new ItemMelee("knife.gold", new MeleeCompKnife(Tiers.GOLD)));
        registry.register(knifeDiamond = new ItemMelee("knife.diamond", new MeleeCompKnife(Tiers.DIAMOND)));

        registry.register(warhammerWood = new ItemMelee("warhammer.wood", new MeleeCompWarhammer(Tiers.WOOD)));
        registry.register(warhammerStone = new ItemMelee("warhammer.stone", new MeleeCompWarhammer(Tiers.STONE)));
        registry.register(warhammerSteel = new ItemMelee("warhammer.iron", new MeleeCompWarhammer(Tiers.IRON)));
        registry.register(warhammerGold = new ItemMelee("warhammer.gold", new MeleeCompWarhammer(Tiers.GOLD)));
        registry.register(warhammerDiamond = new ItemMelee("warhammer.diamond",
                new MeleeCompWarhammer(Tiers.DIAMOND)));

        registry.register(flailWood = new ItemFlail("flail.wood", new MeleeCompNone(Tiers.WOOD)));
        registry.register(flailStone = new ItemFlail("flail.stone", new MeleeCompNone(Tiers.STONE)));
        registry.register(flailSteel = new ItemFlail("flail.iron", new MeleeCompNone(Tiers.IRON)));
        registry.register(flailGold = new ItemFlail("flail.gold", new MeleeCompNone(Tiers.GOLD)));
        registry.register(flailDiamond = new ItemFlail("flail.diamond", new MeleeCompNone(Tiers.DIAMOND)));

        registry.register(katanaWood = new ItemMelee("katana.wood",
                new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, Tiers.WOOD)));
        registry.register(katanaStone = new ItemMelee("katana.stone",
                new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, Tiers.STONE)));
        registry.register(katanaSteel = new ItemMelee("katana.iron",
                new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, Tiers.IRON)));
        registry.register(katanaGold = new ItemMelee("katana.gold",
                new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, Tiers.GOLD)));
        registry.register(katanaDiamond = new ItemMelee("katana.diamond",
                new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, Tiers.DIAMOND)));

        registry.register(boomerangWood = new ItemMelee("boomerang.wood", new MeleeCompBoomerang(Tiers.WOOD)));
        registry.register(boomerangStone = new ItemMelee("boomerang.stone", new MeleeCompBoomerang(Tiers.STONE)));
        registry.register(boomerangSteel = new ItemMelee("boomerang.iron", new MeleeCompBoomerang(Tiers.IRON)));
        registry.register(boomerangGold = new ItemMelee("boomerang.gold", new MeleeCompBoomerang(Tiers.GOLD)));
        registry.register(boomerangDiamond = new ItemMelee("boomerang.diamond",
                new MeleeCompBoomerang(Tiers.DIAMOND)));
