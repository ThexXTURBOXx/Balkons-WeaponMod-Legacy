    ...
    public static LootPool.Builder addShooters(LootPool.Builder lootPool,
        ...
        return lootPool
                ...
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_JAVELIN.get())
                        ...
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(4, 9)))))
    ...
    public static void registerLootTableAdditions(ResourceLocation id,
        ...
        if (BuiltInLootTables.BASTION_BRIDGE.equals(id)) {
            ...
            context.addPool(getProjectileLootPool()
                    .apply(SetItemCountFunction.setCount(RandomValueBounds.between(5, 17)))
        ...
        if (BuiltInLootTables.BASTION_TREASURE.equals(id)) {
            ...
            context.addPool(lootPool.setRolls(RandomValueBounds.between(0, 1)));
            context.addPool(getProjectileLootPool()
                    .apply(SetItemCountFunction.setCount(RandomValueBounds.between(12, 25)))
                    .setRolls(RandomValueBounds.between(0, 1)));
        }
        if (BuiltInLootTables.BURIED_TREASURE.equals(id)) {
            ...
            context.addPool(getExplosiveLootPool().setRolls(RandomValueBounds.between(0, 1)));
        }
        ...
        if (BuiltInLootTables.JUNGLE_TEMPLE_DISPENSER.equals(id)) {
            context.addPool(getProjectileLootPool()
                    .apply(SetItemCountFunction.setCount(RandomValueBounds.between(2, 7)))
                    .setRolls(RandomValueBounds.between(0, 1)));
        }
        ...
        if (BuiltInLootTables.UNDERWATER_RUIN_BIG.equals(id)) {
            context.addPool(getStoneWeaponsLootPool().setRolls(RandomValueBounds.between(0, 1)));
        }
