...
public class WMLootTables {
    ...
    public static LootPool.Builder getCopperWeaponsLootPool() {
        return addCopperWeapons(LootPool.lootPool(), b -> b);
    }

    public static LootPool.Builder addCopperWeapons(LootPool.Builder lootPool,
                                                    Function<LootItem.Builder<?>, LootItem.Builder<?>> mod) {
        return lootPool
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_BATTLEAXE_COPPER.get())
                        .when(cfgCondition("battleaxe"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_BOOMERANG_COPPER.get())
                        .when(cfgCondition("boomerang"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_FLAIL_COPPER.get())
                        .when(cfgCondition("flail"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_KATANA_COPPER.get())
                        .when(cfgCondition("katana"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_HALBERD_COPPER.get())
                        .when(cfgCondition("halberd"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_KNIFE_COPPER.get())
                        .when(cfgCondition("knife"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_MUSKET_COPPER.get())
                        .when(cfgCondition("musket", "knife"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_SPEAR_COPPER.get())
                        .when(cfgCondition("spear"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))))
                .add(mod.apply(LootItem.lootTableItem(WMRegistries.ITEM_WARHAMMER_COPPER.get())
                        .when(cfgCondition("warhammer"))
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))));
    }
    ...
    public static void registerLootTableAdditions(HolderLookup.Provider registries, ResourceKey<LootTable> key,
        ...
        if (BuiltInLootTables.VILLAGE_WEAPONSMITH.equals(key)) {
            LootPool.Builder lootPool = LootPool.lootPool();
            addIronWeapons(lootPool, b -> b.setWeight(5));
            addCopperWeapons(lootPool, b -> b.setWeight(7));
            context.addPool(lootPool.setRolls(UniformGenerator.between(0, 1)));
        }
