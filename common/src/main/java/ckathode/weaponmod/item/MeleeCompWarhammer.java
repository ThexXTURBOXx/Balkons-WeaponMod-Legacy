...
public class MeleeCompWarhammer extends MeleeComponent {
    ...
    protected void superSmash(ItemStack itemstack, Level world, LivingEntity entityLiving) {
        ...
        DamageSource source = entityLiving instanceof Player
                ? DamageSource.playerAttack((Player) entityLiving)
        ...
        if (entityLiving instanceof Player) {
            ((Player) entityLiving).causeFoodExhaustion(6.0f);
            setSmashed((Player) entityLiving);
        }
    }
