...
public final class WMItemVariants {
    ...
    public static void registerItemVariants(Item item, String... variants) {
        registerItemVariants(BalkonsWeaponMod.MOD_ID, item, variants);
    }

    public static void registerItemVariants(String modId, Item item, String... variants) {
        registerItemVariants(modId, item.getRegistryName(), "inventory", item, variants);
    }

    public static void registerItemVariants(String id, String string2, Item item, String... variants) {
        registerItemVariants(BalkonsWeaponMod.MOD_ID, id, string2, item, variants);
    }

    public static void registerItemVariants(String modId, String id, String string2, Item item, String... variants) {
        ModelLoader.setCustomModelResourceLocation(item, 0, new ModelResourceLocation(
                modId + ":" + item.getUnlocalizedName().substring(5), string2));
