...
public abstract class PhysHelper
{
    ...
    public static AdvancedExplosion createStandardExplosion(final World world, final Entity entity, final double d, final double d1, final double d2, final float size, final boolean flame, final boolean smoke) {
    ...
    public static AdvancedExplosion createAdvancedExplosion(final World world, final Entity entity, final double d, final double d1, final double d2, final float size, final boolean destroyBlocks, final boolean spawnSmallParticles, final boolean spawnBigParticles, final boolean flame, final boolean smoke) {
        final AdvancedExplosion explosion = new AdvancedExplosion(world, entity, d, d1, d2, size, flame, smoke);
        explosion.doEntityExplosion();
        if (destroyBlocks) {
            explosion.doBlockExplosion();
    ...
    public static AdvancedExplosion createAdvancedExplosion(final World world, final Entity entity, final DamageSource damagesource, final double d, final double d1, final double d2, final float size, final boolean destroyBlocks, final boolean spawnSmallParticles, final boolean spawnBigParticles, final boolean flame, final boolean smoke) {
        final AdvancedExplosion explosion = new AdvancedExplosion(world, entity, d, d1, d2, size, flame, smoke);
    ...
    public static AdvancedExplosion createAdvancedExplosion(final World world, final Entity entity, final double d, final double d1, final double d2, final float size, final boolean destroyBlocks, final boolean spawnParticles, final boolean flame, final boolean smoke) {
        final AdvancedExplosion explosion = new AdvancedExplosion(world, entity, d, d1, d2, size, flame, smoke);
        explosion.doEntityExplosion();
        if (destroyBlocks) {
            explosion.doBlockExplosion();
    ...
    public static void sendExplosion(final World world, final AdvancedExplosion explosion, final boolean smallparts, final boolean bigparts) {
        if (world instanceof WorldServer && !world.isRemote) {
            final MsgExplosion msg = new MsgExplosion(explosion, smallparts, bigparts);
            BalkonsWeaponMod.instance.messagePipeline.sendToAllAround(msg, new NetworkRegistry.TargetPoint(world.provider.getDimension(), explosion.explosionX, explosion.explosionY, explosion.explosionZ, 64.0));
        }
    }
    ...
    public static void knockBack(final EntityLivingBase entityliving, final EntityLivingBase attacker, final float knockback) {
        ...
        entityliving.attackedAtYaw = (float)(Math.atan2(dz, dx) * 180.0 / 3.141592653589793) - entityliving.rotationYaw;
