...
public class WMItemBuilder {
    ...
    public static ItemMelee createStandardBattleaxe(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemBlowgunDart createStandardBlowgunDart(String modId, String id) {
        return createItemBlowgunDart(modId, id);
    }
    ...
    public static ItemMelee createStandardBoomerang(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemFlail createStandardFlail(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemMelee createStandardHalberd(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemMelee createStandardKatana(String modId, String id, @NotNull Item.ToolMaterial tier) {
        return createItemMelee(modId, id, new MeleeComponent(MeleeComponent.MeleeSpecs.KATANA, tier));
    }

    public static ItemMelee createStandardKnife(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemMusket createStandardMusketWithBayonet(String modId, String id, @NotNull Item.ToolMaterial tier,
                                                             @NotNull Item bayonetItem) {
        return createItemMusket(modId, id, new MeleeCompKnife(tier), bayonetItem);
    }

    public static ItemMelee createStandardSpear(String modId, String id, @NotNull Item.ToolMaterial tier) {
        return createItemMelee(modId, id, new MeleeCompSpear(tier));
    }

    public static ItemMelee createStandardWarhammer(String modId, String id, @NotNull Item.ToolMaterial tier) {
    ...
    public static ItemBlowgunDart createItemBlowgunDart(String modId, String id) {
        return new ItemBlowgunDart(modId, id);
    }
