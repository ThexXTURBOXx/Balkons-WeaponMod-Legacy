...
public class WMClientProxy extends WMCommonProxy {
    ...
    public void registerRenderersItem(final WeaponModConfig config) {
        ...
        if (config.isEnabled("musket")) {
            ...
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.musket_iron_part, 0,
                    new ModelResourceLocation("weaponmod:" + BalkonsWeaponMod.musket_iron_part.getTranslationKey().substring(5), "inventory"));
        }
        ...
        if (config.isEnabled("blowgun")) {
            ...
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.dart, 1, new ModelResourceLocation("weaponmod"
                                                                                                           + ":" + BalkonsWeaponMod.dart.getTranslationKey().substring(5) + "_hunger", "inventory"));
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.dart, 2, new ModelResourceLocation("weaponmod"
                                                                                                           + ":" + BalkonsWeaponMod.dart.getTranslationKey().substring(5) + "_slow", "inventory"));
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.dart, 3, new ModelResourceLocation("weaponmod"
                                                                                                           + ":" + BalkonsWeaponMod.dart.getTranslationKey().substring(5) + "_damage", "inventory"));
        }
        ...
        if (config.isEnabled("blunderbuss")) {
            ...
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.blunder_iron_part, 0,
                    new ModelResourceLocation("weaponmod:" + BalkonsWeaponMod.blunder_iron_part.getTranslationKey().substring(5), "inventory"));
        }
        ...
        if (config.isEnabled("mortar")) {
            ...
            ModelLoader.setCustomModelResourceLocation(BalkonsWeaponMod.mortar_iron_part, 0,
                    new ModelResourceLocation("weaponmod:" + BalkonsWeaponMod.mortar_iron_part.getTranslationKey().substring(5), "inventory"));
        }
    }
