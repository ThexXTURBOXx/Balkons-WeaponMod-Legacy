...
public class EntityCannonBall extends EntityProjectile
{
    ...
    public EntityCannonBall(final World world, final EntityCannon entitycannon, final float f, final float f1, final boolean superPowered) {
        this(world, entitycannon.posX, entitycannon.posY + 1.0, entitycannon.posZ);
        final Entity entityPassenger = entitycannon.getPassengers().isEmpty() ? null : entitycannon.getPassengers().get(0);
    ...
    public void createCrater() {
        ...
        PhysHelper.createAdvancedExplosion(this.world, this, this.posX, this.posY, this.posZ, f, BalkonsWeaponMod.instance.modConfig.cannonDoesBlockDamage, true, false, false);
    }
