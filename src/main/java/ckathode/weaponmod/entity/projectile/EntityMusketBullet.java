    ...
    public void onUpdate() {
        ...
        if (speed > 2.0) {
            for (int i1 = 1; i1 < amount; ++i1) {
                this.world.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, this.posX + this.motionX * i1 / amount, this.posY + this.motionY * i1 / amount, this.posZ + this.motionZ * i1 / amount, 0.0, 0.0, 0.0, new int[0]);
            }
        }
    }
