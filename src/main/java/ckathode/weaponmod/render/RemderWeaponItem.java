...
public class RemderWeaponItem implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        float t = 0.0625F;
        renderItemIn2D(tess, icon.getMaxU(), icon.getMinV(), icon.getMinU(), icon.getMaxV(), icon.getIconWidth(),
                icon.getIconHeight(), t);
        renderEnchantEffect(tess, item, 256, 256, t);
    }

    protected void renderItemIn2D(Tessellator tess, float texU0, float texV0, float texU1, float texV1, int iconwidth
            , int iconheight, float thickness) {
