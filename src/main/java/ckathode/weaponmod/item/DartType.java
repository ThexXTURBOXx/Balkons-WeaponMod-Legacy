...
public class DartType {
    ...
    public static DartType damage = new DartType((byte) 0, "dart", new PotionEffect(MobEffects.POISON, 120, 0));
    ...
    public DartType(final byte id, final String typename, final PotionEffect potioneffect) {
