...
public class DartType {
    ...
    public static final DartType hunger = new DartType((byte) 1, "dart.hunger", new EffectInstance(Effects.HUNGER,
            360, 0));
    public static final DartType slow = new DartType((byte) 2, "dart.slow",
            new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 360, 1));
    public static final DartType damage2 = new DartType((byte) 3, "dart.damage", new EffectInstance(Effects.POISON,
            120, 1));
