...
public final class DartType {
    ...
    public static final DartType DAMAGE = new DartType("dart",
            new float[]{0.2f, 0.8f, 0.3f}, new EffectInstance(Effects.POISON, 120, 0));
    public static final DartType HUNGER = new DartType("dart.hunger",
            new float[]{0.9f, 0.7f, 1.0f}, new EffectInstance(Effects.HUNGER, 360, 0));
    public static final DartType SLOW = new DartType("dart.slow",
            new float[]{0.6f, 1.0f, 0.9f}, new EffectInstance(Effects.SLOWNESS, 360, 1));
    public static final DartType DAMAGE_2 = new DartType("dart.damage",
            new float[]{0.8f, 0.5f, 0.2f}, new EffectInstance(Effects.POISON, 120, 1));

    public final String typeName;
    public final float[] color;
    public final List<EffectInstance> potionEffects;
     ...
     */
    public DartType(String typeName, float[] color, EffectInstance... potionEffects) {
        DART_TYPES.add(this);
